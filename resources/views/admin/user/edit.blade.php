                        ...
                        <div class="row">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{ url('admin/user/update-user/'.$user->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                           ...
                                           <input type="text" name="name" value="{{ $user->name }}" class="form-control">
                                            ...
                                            <p type="text" name="created_at" class="form-control">{{ $user->created_at->format('d/m/Y') }}"  </p>
