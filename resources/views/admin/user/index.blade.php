        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    ...
                    <h1 class="mt-4">Users <a href={{ url('admin/add-user') }}
                            ...
                            <table id="myDataTable" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($users as $item)
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td>{{ $item->name }}</td> {{-- category là function  category trong model Post , rồi trả về name của category--}}
                                            <td>{{ $item->email }}</td>
                                            <td>{{ $item->role_as == 1? "Admin":"User" }}</td>
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ url('admin/user/edit-user/'.$item->id) }}" type="button" class="btn btn-primary" style="margin-right:10px ">Update</a>
                                                    <a href="{{ url('admin/user/delete-user/'.$item->id) }}" type="button" class="btn btn-danger">Delete</a>
                                                </div>
                                            </td>
