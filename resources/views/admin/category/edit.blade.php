                        ...
                        <div class="row">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{ url('admin/category/update-category/'.$category->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="image" {{ $category->image }}  class="form-control">
