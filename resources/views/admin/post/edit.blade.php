                        ...
                        <div class="row">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{ url('admin/post/update-post/'.$post->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                           ...
                                           <input type="text" name="name" value="{{ $post->name }}" class="form-control">
                                            ...
                                            <textarea type="text" name="description" id="mySummernote" rows="5"  class="form-control">{!! $post->description !!}</textarea>
